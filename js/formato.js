...
function cargar_datos(){
    ...
    for(var i=0; i < autorizados.length ;i++ ){
        nombre_autorizado.innerHTML += "<option value='"+autorizados[i+1]+"'>"+autorizados[i]+"</option>";
        i=i+1;
    }
...
function generar_tabla(){
  ...
  $("#tabla_registros").empty();//limpiar tabla
    ...
    for (var j = 0; j < document.getElementById("cont_user").value; j++) {
        ...
        cell2.innerHTML = "<input type='text' class='form-control' id='' placeholder='' required minlength='9'>";
        cell3.innerHTML = "<input type='text' class='form-control' id='' placeholder='' required minlength='9'>";
        cell4.innerHTML = "<input type='number' class='form-control' id='' placeholder='' required min='1000000' maxlength='10' oninput='if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);'>";
        cell5.innerHTML = "<input type='text' class='form-control' id='' placeholder='' required minlength='7' maxlength='9'>";;
        cell6.innerHTML = "<input type='email' class='form-control' id='' placeholder='' required>";
        //cell7.innerHTML = '';
    }
